    ...
    <div className="space-y-8">
      ...
      <div className="bg-[#111] border border-white/5 rounded-2xl p-6 shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="flex items-center justify-end text-[10px] font-black uppercase tracking-widest text-white/20 pr-2">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white/2 border-b border-white/5">
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-maroon">#</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Athlete</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Race</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Division</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Gender</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Age</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Time</th>
            ...
            <tbody className="divide-y divide-white/5">
              {sorted.map((p, idx) => (
                <tr key={`${p.name}-${p.tabName}`} className="hover:bg-white/2 transition-colors group">
                  ...
                  <td className="px-8 py-6 text-sm font-bold text-white/40 uppercase tracking-widest">{p.tabName}</td>
                  <td className="px-8 py-6">
                    <span className={cn(
                  ...
                  <td className="px-8 py-6 text-sm font-bold text-white/60">{p.ageGroup}</td>
                  <td className="px-8 py-6 font-mono text-xl font-black text-white">{p.completionTime}</td>
